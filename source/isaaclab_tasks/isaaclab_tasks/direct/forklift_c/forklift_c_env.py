...
from isaaclab_assets.robots.forklift_c import FORKLIFT_C_CFG
...
STOP_SIGN_CFG = RigidObjectCfg(
    ...
    spawn=UsdFileCfg(
        ...
        usd_path="C:/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/direct/forklift_c/custom_assets/STOP.usd",
        scale=(0.2, 0.2, 0.2),
